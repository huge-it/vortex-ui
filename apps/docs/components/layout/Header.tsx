      ...
      <Toolbar sx={{ display: 'flex', justifyContent: 'space-between' }}>
        <Box display="flex" alignItems="center" gap={3}>
          ...
          <Box display="flex" gap={2}>
            <Link href="/" color="inherit" underline="none" sx={{ fontWeight: 500, fontSize: '0.875rem' }}>
              Home
            </Link>
            <Link href="/components/button" color="inherit" underline="none" sx={{ fontWeight: 500, fontSize: '0.875rem' }}>
              Components
            </Link>
          </Box>
        </Box>
